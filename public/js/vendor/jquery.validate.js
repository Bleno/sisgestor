...
$.extend($.validator, {
	...
	messages: {
		...
		max: $.validator.format("Por favor introduza um valor inferior ou igual a {0}."),
		min: $.validator.format("Por favor introduza um valor superior ou igual a {0}.")
	},
